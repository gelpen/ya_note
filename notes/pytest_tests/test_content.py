...
# В написанных тестах в assert-выражениях применены разные сравнения — in и not in.
# При объединении тестов можно использовать одну и ту же конструкцию in, но сравнивать её со значениями True и False.
